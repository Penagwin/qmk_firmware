...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_ESC_CAPS]  = ACTION_TAP_DANCE_DOUBLE(KC_GRAVE, KC_ESC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        TD(TD_ESC_CAPS),  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_DEL,  \
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, KC_F5, \
        LT(2, KC_CAPS), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_VOLU, \
    ...
    [1] = LAYOUT(
        ...
        KC_U, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_PGUP, \
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,          KC_UP,   KC_PGDN, \
        KC_LCTL, XXXXXXX, KC_LALT,                            KC_SPC,                             KC_RALT, _______,   KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
    [2] = LAYOUT(
        ...
        L_T_PTD, L_PTP,   L_BRD,   L_PTN,   _______, TG(1), _______, _______, _______, _______, _______, _______,          _______, KC_VOLU, \
...
led_instruction_t led_instructions[] = {
    ...
    // { .flags = LED_FLAG_USE_ROTATE_PATTERN },
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB, .id0 = 0xFFFF8000, .id1 = 0xFFFFFFFF, .id2 = 0x00000007, .r = 255, .g = 255,  .b = 255, .layer = 2 },
